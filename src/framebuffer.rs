...
// use crate::board;
use crate::co5300::LCD_WIDTH;
use crate::co5300::LCD_HEIGHT;
use crate::co5300::Co5300Display;
use crate::co5300::DisplayError;
...
impl Framebuffer {
    ...
    /// View the front buffer as Slint's pixel type for rendering.
    /// Safe: Rgb565Pixel is #[repr(transparent)] over u16.
    pub fn as_rgb565_pixels_mut(&mut self) -> &mut [Rgb565Pixel] {
        unsafe {
            core::slice::from_raw_parts_mut(
                self.buf.as_mut_ptr() as *mut Rgb565Pixel,
                self.buf.len(),
            )
        }
    }
